! function(a) {
    ...
    function o(t) {
        document.getElementById("header-lang-img") && ("en" == t ? document.getElementById("header-lang-img").src = "assets/images/flags/us.jpg" : "sp" == t ? document.getElementById("header-lang-img").src = "assets/images/flags/spain.jpg" : "gr" == t ? document.getElementById("header-lang-img").src = "assets/images/flags/germany.jpg" : "it" == t ? document.getElementById("header-lang-img").src = "assets/images/flags/italy.jpg" : "ru" == t && (document.getElementById("header-lang-img").src = "assets/images/flags/russia.jpg"), localStorage.setItem("language", t), "null" == (n = localStorage.getItem("language")) && o(s), a.getJSON("assets/lang/" + n + ".json", function(t) {
            a("html").attr("lang", n), a.each(t, function(t, e) {
                "head" === t && a(document).attr("title", e.title), a("[key='" + t + "']").text(e)
            })
        }))
    }
    ...
    a("#side-menu").metisMenu(), i(), e = document.body.getAttribute("data-sidebar-size"), a(window).on("load", function() {
        ...
        }), document.addEventListener("fullscreenchange", d), document.addEventListener("webkitfullscreenchange", d), document.addEventListener("mozfullscreenchange", d),
        function() {
        ...
        }), window.sessionStorage && ((t = sessionStorage.getItem("is_visited")) ? a("#" + t).prop("checked", !0) : sessionStorage.setItem("is_visited", "layout-ltr")), a("#password-addon").on("click", function() {
        ...
        }), "null" != n && n !== s && o(n), a(".language").on("click", function(t) {
        ...
        function() {
            ...
            t.hasAttribute("data-layout") && "horizontal" == t.getAttribute("data-layout") ? (l("layout-horizontal"), a(".sidebar-setting").hide()) : l("layout-vertical"), t.hasAttribute("data-layout-mode") && "dark" == t.getAttribute("data-layout-mode") ? l("layout-mode-dark") : l("layout-mode-light"), t.hasAttribute("data-layout-size") && "boxed" == t.getAttribute("data-layout-size") ? l("layout-width-boxed") : l("layout-width-fuild"), t.hasAttribute("data-layout-scrollable") && "true" == t.getAttribute("data-layout-scrollable") ? l("layout-position-scrollable") : l("layout-position-fixed"), t.hasAttribute("data-topbar") && "dark" == t.getAttribute("data-topbar") ? l("topbar-color-dark") : l("topbar-color-light"), t.hasAttribute("data-sidebar-size") && "sm" == t.getAttribute("data-sidebar-size") ? l("sidebar-size-small") : t.hasAttribute("data-sidebar-size") && "md" == t.getAttribute("data-sidebar-size") ? l("sidebar-size-compact") : l("sidebar-size-default"), t.hasAttribute("data-sidebar") && "brand" == t.getAttribute("data-sidebar") ? l("sidebar-color-brand") : t.hasAttribute("data-sidebar") && "dark" == t.getAttribute("data-sidebar") ? l("sidebar-color-dark") : l("sidebar-color-light"), document.getElementsByTagName("html")[0].hasAttribute("dir") && "rtl" == document.getElementsByTagName("html")[0].getAttribute("dir") ? l("layout-direction-rtl") : l("layout-direction-ltr"), a("input[name='layout']").on("change", function() {
